        ...
        return (
            <div className="appointments" >
                <div className="titles">
                    <div className="ffName">Full Name</div>
                    <div className="addApp">Address</div>
                    <div className="cityApp">City</div>
                    <div className="zipApp">Zip Code</div>
                    <div className="phoneApp">Phone #</div>
                    <div className="winApp">Windows</div>
                    <div className="hWinApp">High Widows</div>
                    ...
                    return (
                        <div key={appointment.quote_id}>
                            ...
                            <div className="totalApp">Total</div> */}
                                ...
                                <div className="phoneApp">{` ${appointment.phone}`}</div>
